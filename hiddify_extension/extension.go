...
func init() {
	ex.RegisterExtension(
		ex.ExtensionFactory{
			Id:          "github.com/Jelingam/warp/hiddify_extension", // Package identifier
			Title:       "Warp",                                                         // Display title of the extension
			Description: "Awesome Extension warp created by Jelingam",                                                     // Brief description of the extension
